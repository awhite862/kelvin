...
class QuadTest(unittest.TestCase):
    ...
    def test_int_keldysh(self):
        ...
        t1f, t1b, t1i = quadrature.int_tbar1_keldysh(
            ngr, ngi, T1f, T1b, T1i, tir, tii, D1, Gr, Gi)
        t2f, t2b, t2i = quadrature.int_tbar2_keldysh(
            ngr, ngi, T2f, T2b, T2i, tir, tii, D2, Gr, Gi)
    ...
    def test_Lint_keldysh(self):
        ...
        l1f, l1b, l1i = quadrature.int_L1_keldysh(
            ngr, ngi, L1f, L1b, L1i, tir, tii, D1, gr, gi, Gr, Gi)
        l2f, l2b, l2i = quadrature.int_L2_keldysh(
