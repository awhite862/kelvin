    ...
    for y in range(ngi):
        for i in range(n):
            for a in range(n):
                ...
                TP[y,a,i] += d
                TM[y,a,i] -= d
                LP = evalL(cc.T1f,cc.T1b,TP,cc.T2f,cc.T2b,cc.T2i,cc.L1f,cc.L1b,cc.L1i,cc.L2f,cc.L2b,cc.L2i,
                    Ff,Fb,F,I,D1,D2,tir,tii,gr,gi,Gr,Gi,beta)
                LM = evalL(cc.T1f,cc.T1b,TM,cc.T2f,cc.T2b,cc.T2i,cc.L1f,cc.L1b,cc.L1i,cc.L2f,cc.L2b,cc.L2i,
                        Ff,Fb,F,I,D1,D2,tir,tii,gr,gi,Gr,Gi,beta)
                diff = (LP - LM)/(2*d)
    ...
    for y in range(ngr):
        for i in range(n):
            for a in range(n):
                ...
                TP[y,a,i] += d
                TM[y,a,i] -= d
                LP = evalL(cc.T1f,TP,cc.T1i,cc.T2f,cc.T2b,cc.T2i,cc.L1f,cc.L1b,cc.L1i,cc.L2f,cc.L2b,cc.L2i,
                    Ff,Fb,F,I,D1,D2,tir,tii,gr,gi,Gr,Gi,beta)
                LM = evalL(cc.T1f,TM,cc.T1i,cc.T2f,cc.T2b,cc.T2i,cc.L1f,cc.L1b,cc.L1i,cc.L2f,cc.L2b,cc.L2i,
                        Ff,Fb,F,I,D1,D2,tir,tii,gr,gi,Gr,Gi,beta)
                diff = (LP - LM)/(2*d)
                if numpy.abs(diff) > thresh:
    ...
    for y in range(ngr):
        for i in range(n):
            for a in range(n):
                ...
                TP[y,a,i] += d
                TM[y,a,i] -= d
                LP = evalL(TP,cc.T1b,cc.T1i,cc.T2f,cc.T2b,cc.T2i,cc.L1f,cc.L1b,cc.L1i,cc.L2f,cc.L2b,cc.L2i,
                    Ff,Fb,F,I,D1,D2,tir,tii,gr,gi,Gr,Gi,beta)
                LM = evalL(TM,cc.T1b,cc.T1i,cc.T2f,cc.T2b,cc.T2i,cc.L1f,cc.L1b,cc.L1i,cc.L2f,cc.L2b,cc.L2i,
                        Ff,Fb,F,I,D1,D2,tir,tii,gr,gi,Gr,Gi,beta)
                diff = (LP - LM)/(2*d)
                if numpy.abs(diff) > thresh:
